        ...
        <v-col sm="4">
          <div class="counter-item">
            ...
            <div class="text">
              ...
              <h6 class="use-text-subtitle2">Lorem Ipsum dolor</h6>
            </div>
          </div>
        </v-col>
        <v-col sm="4">
          <div class="counter-item">
            ...
            <div class="text">
              ...
              <h6 class="use-text-subtitle2">Pellentesque ac bibendum</h6>
            </div>
          </div>
        </v-col>
        <v-col sm="4">
          <div class="counter-item">
            ...
            <div class="text">
              ...
              <h6 class="use-text-subtitle2">consectetur adipiscing </h6>
            </div>
          </div>
        </v-col>
      </v-row>
